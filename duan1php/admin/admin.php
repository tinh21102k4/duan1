...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li <?php if (isset($_GET['page'])){ if($_GET['page']=='category'||$_GET['page']=='update_category'||$_GET['page']=='edit_category'||$_GET['page']=='del_category'){ echo 'class="active"';} }  ?>><a href="index.php?page=category"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg>Quản lý danh mục</a></li>
	...
	if(isset($_GET['page'])) {
		switch ($_GET['page']) {
			...
			case 'category':
				...
				case 'edit_category':
					if (isset($_GET['itemsid']) && ($_GET['itemsid'] > 0)) {
						$itemsid = loadone_danhmuc($_GET['itemsid']);
					}
					include "modules/category/edit_category.php";
					break;            
				case 'update_category':
					if (isset($_POST['submit_category']) && ($_POST['submit_category'])) {
						$cate = $_POST['category'];
						$itemsid = $_POST['itemsid'];
						update_danhmuc($itemsid,$cate);

<?php 
   ...
   $sql_category = "SELECT * FROM category ORDER BY id DESC";
    ...
    $sql_pagination = "SELECT * FROM category ORDER BY id DESC LIMIT $start,$rowPerPage";
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Danh sách loại hàng</h1>
        </div>
    </div><!--/.row-->
    <div id="toolbar" class="btn-group">
        <a href="index.php?page=add_category" class="btn btn-success">
            <i class="glyphicon glyphicon-plus"></i> Thêm loại hàng
        </a>
    </div>
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <tbody>                           
                                ...
                                if(mysqli_num_rows($resultPagination) > 0) {
                                    ...
                                    <tr>
                                        ...
                                        <td ><?php echo $row['itemsid']; ?></td>
                                        <td ><?php echo $row['category']; ?></td>
                                        <td class="form-group">
                               		        <a href="index.php?page=edit_category&itemsid=<?php echo $row['itemsid']; ?>" class="btn btn-primary"><i class="glyphicon glyphicon-pencil"></i></a>
                                 	        <a  onclick="return confirmDel();" href="index.php?page=del_category&itemsid=<?php echo $row['itemsid']; ?>" class="btn btn-danger"><i class="glyphicon glyphicon-remove"></i></a>
                               	        </td>
                                    <tr>
                                <?php         
                                    }

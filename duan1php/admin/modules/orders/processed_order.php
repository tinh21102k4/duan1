...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
	...
	<div id="toolbar" class="btn-group">
		<a href="index.php?page=order_new" class="btn btn-success">
			<i class="glyphicon glyphicon-plus"></i> Đơn chưa xử lý
		</a>
		<a href="index.php?page=processed_order" class="btn btn-success" style="background:#1f7223;">
                            	...
                            	?> 
									<tr>
										...
										<td class="form-group">
											...
											<a href="modules/orders/order_edit.php?prd_id=<?php echo $row['invoiceid']; ?>&case=23" class="btn btn-warning"><i class="glyphicon glyphicon-pencil"></i></a>

<?php 
    ...
    $sql_product = "SELECT * FROM product ORDER BY prdid DESC";
    ...
    $sql_pagination = "SELECT * FROM product ORDER BY prdid DESC LIMIT $start,$rowPerPage";
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if($prdcount["SUM(amount)"]>$prdsold["SUM(amount)"] ) { 
                                        ?>

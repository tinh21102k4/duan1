...
$thu_muc_anh = 'images/';
$rowPerPage = 6;
$sql = "SELECT * from product INNER JOIN category ON product.prdid=category.itemsid WHERE category='dress'";
...
$sql_pagination = "SELECT * from product INNER JOIN category ON product.prdid=category.itemsid WHERE category='dress' LIMIT $start,$rowPerPage";

		<!-- ======================= Top Breadcrubms ======================== -->
		<?php 	
				$loadonesp = load_one_spct($_GET['prdid']);
				foreach($loadonesp as $onesp) { ?>
				<?php } ?>
        <div class="gray py-3">
				<div class="container">
					<div class="row">
						<div class="colxl-12 col-lg-12 col-md-12">
							<nav aria-label="breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item"><a href="#"><?php echo $onesp['category']?></a></li>
									<li class="breadcrumb-item active" aria-current="page"><?php echo $onesp['name']?></li>
								</ol>
							</nav>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="sp-loading"><img src="images/<?php echo $onesp['image']?>" alt=""><br>LOADING IMAGES</div>
							<div class="sp-wrap">
								<a href="images/<?php echo $onesp['image']?>"><img src="images/<?php echo $onesp['image']?>" alt=""></a>
								<a href="images/<?php echo $onesp['image']?>"><img src="images/<?php echo $onesp['image']?>" alt=""></a>
								<a href="images/<?php echo $onesp['image']?>"><img src="images/<?php echo $onesp['image']?>" alt=""></a>
								<a href="images/<?php echo $onesp['image']?>"><img src="images/<?php echo $onesp['image']?>" alt=""></a>
								<a href="images/<?php echo $onesp['image']?>"><img src="images/<?php echo $onesp['image']?>" alt=""></a>
						...
						<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
							<div class="prd_details">
								...
								<div class="prt_01 mb-2"><span class="text-success bg-light-success rounded px-2 py-1"><?php echo $onesp['category']?></span></div>
								<div class="prt_02 mb-3">
									<h2 class="ft-bold mb-1"><?php echo $onesp['name']?></h2>
									<div class="text-left">
										...
										<div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2">499000VND</span><span class="ft-bold theme-cl fs-lg"><?php echo $onesp['price']?> VND</span></div>
									</div>
								</div>
								
								<div class="prt_03 mb-4">
									<p>Miêu tả : <br> <?php echo $onesp['description']?></p>
								</div>
								...
								<div class="prt_05 mb-4">
									<div class="form-row mb-7">
										...
										<div class="col-12 col-lg">
											<!-- Submit -->
											<a href="index.php?act=cart"><button type="submit" class="btn btn-block custom-height bg-dark mb-2">
												<i class="lni lni-shopping-basket mr-2"></i>Add to Cart 
											</button></a>
										</div>
										<div class="col-12 col-lg-auto">
											<!-- Wishlist -->
											<a href="index.php?act=wishlist"><button type="submit" class="btn custom-height btn-default btn-block mb-2 text-dark" >
						...
						<div class="col-xl-11 col-lg-12 col-md-12 col-sm-12">
							<ul class="nav nav-tabs b-0 d-flex align-items-center justify-content-center simple_tab_links mb-4" id="myTab" role="tablist">
								<li class="nav-item" role="presentation">
									<a class="nav-link active" id="description-tab" href="#description" data-toggle="tab" role="tab" aria-controls="description" aria-selected="true">MIÊU TẢ</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="#information" id="information-tab" data-toggle="tab" role="tab" aria-controls="information" aria-selected="false">THÔNG TIN SẢN PHẨM</a>
								</li>
								<li class="nav-item" role="presentation">
									<a class="nav-link" href="#reviews" id="reviews-tab" data-toggle="tab" role="tab" aria-controls="reviews" aria-selected="false">ĐÁNH GIÁ</a>
								</li>
							</ul>
							...
							<div class="tab-content" id="myTabContent">
								...
								<div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
									<div class="description_info">
										<p class="p-0 mb-2"><?php echo $onesp['name']?></p>
										<p class="p-0"><?php echo $onesp['description']?></p>
									</div>
								</div>
										...
										<table class="table">
											<tbody>
												<tr>
												  ...
												  <td><?php echo $onesp['prdid']?></td>
												</tr>
												<tr>
												  <th class="ft-medium text-dark">DẠNG :</th>
												  <td><?php echo $onesp['category']?></td>
												</tr>
												<tr>
												  <th class="ft-medium text-dark">MÀU :</th>
												  <td><?php echo $onesp['color']?></td>
												</tr>
												<tr>
												  <th class="ft-medium text-dark">KÍCH CỠ :</th>
												  <td><?php echo $onesp['size']?></td>
												</tr>
												<tr>
												  <th class="ft-medium text-dark">CÂN NẶNG :</th>
												  <td>450 Gr</td>
												</tr>
											</tbody>
										</table>
			...
			<s	ection class="middle pt-0">
				<div class="container">
					
					<div class="row justify-content-center">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
							<div class="sec_title position-relative text-center">
								<h2 class="off_title">XEM NGAY</h2>
								<h3 class="ft-bold pt-3">CÁC SẢN PHẨM LIÊN QUAN</h3>
							</div>
						</div>
					</div>
									...
									<div class="product_grid card b-0 mb-0">
										...
										<div class="card-body p-0">
											<div class="shop_thumb position-relative">
												<a class="card-img-top d-block overflow-hidden" href="index.php?act=sanphamct&prdid=<?php echo $lq['prdid']?>"><img class="card-img-top" src="images/<?php echo $lq['image']?>" alt="..."></a>
										...
										<div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
											<div class="text-left">
												<div class="text-center">
													<h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="index.php?act=sanphamct&prdid=<?php echo $lq['prdid']?>"><?php echo $lq['name']?></a></h5>
													<div class="elis_rty"><span class="ft-bold fs-md text-dark"><?php echo $lq['price']?></span></div>
												</div>
											</div>
										</div>
									</div>
